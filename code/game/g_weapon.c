...
===============
*/
void CalcMuzzlePoint(gentity_t *ent, vec3_t localForward, vec3_t localRight,
                     vec3_t localUp, vec3_t muzzlePoint) {
...
===============
*/
void CalcMuzzlePointOrigin(gentity_t *ent, vec3_t origin, vec3_t localForward,
                           vec3_t localRight, vec3_t localUp,
                           vec3_t muzzlePoint) {
  VectorCopy(ent->s.pos.trBase, muzzlePoint);
  muzzlePoint[2] += ent->client->ps.viewheight;
  VectorMA(muzzlePoint, 14, localForward, muzzlePoint);
