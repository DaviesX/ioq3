...
typedef intptr_t(QDECL *vmMainProc)(int callNum, int arg0, int arg1, int arg2,
...
void Field_CompleteFilename(const char *dir, const char *ext, char *filter,
                            qboolean stripExt,
                            qboolean allowNonPureFilesOnDisk);
...
void QDECL Com_Error(int code, const char *fmt, ...) Q_NO_RETURN
    Q_PRINTF_FUNC(2, 3);
