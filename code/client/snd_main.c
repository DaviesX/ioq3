...
static qboolean S_ValidSoundInterface(soundInterface_t *pSi) {
  ...
  if (!pSi->StartSound)
    return qfalse;
  if (!pSi->StartLocalSound)
    return qfalse;
  if (!pSi->StartBackgroundTrack)
    return qfalse;
  if (!pSi->StopBackgroundTrack)
    return qfalse;
  if (!pSi->RawSamples)
    return qfalse;
  if (!pSi->StopAllSounds)
    return qfalse;
  if (!pSi->ClearLoopingSounds)
    return qfalse;
  if (!pSi->AddLoopingSound)
    return qfalse;
  if (!pSi->AddRealLoopingSound)
    return qfalse;
  if (!pSi->StopLoopingSound)
    return qfalse;
  if (!pSi->Respatialize)
    return qfalse;
  if (!pSi->UpdateEntityPosition)
    return qfalse;
  if (!pSi->Update)
    return qfalse;
  if (!pSi->DisableSounds)
    return qfalse;
  if (!pSi->BeginRegistration)
    return qfalse;
  if (!pSi->RegisterSound)
    return qfalse;
  if (!pSi->ClearSoundBuffer)
    return qfalse;
  if (!pSi->SoundInfo)
    return qfalse;
  if (!pSi->SoundList)
  ...
  if (!pSi->StartCapture)
    return qfalse;
  if (!pSi->AvailableCaptureSamples)
    return qfalse;
  if (!pSi->Capture)
    return qfalse;
  if (!pSi->StopCapture)
